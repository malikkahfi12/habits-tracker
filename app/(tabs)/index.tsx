...
export default function Index() {
  ...
  useEffect(() => {
    if (user) {
      ...
      const completionSubscription = client.subscribe(completionChannel,
        (response: RealTimeResponse) => {
          if (response.events.includes("databases.*.collections.*.documents.*.create")) {
  ...
  const handleCompletedHabits = async (id: string) => {
  ...
  return (
    <View
      ...
      <View style={styles.header}>
        <Text style={styles.title} variant="headlineSmall">Todays Habits</Text>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        {habits?.length === 0 ? (
          <View style={styles.emptyState}>
            <Text style={styles.empyStateText}>No Habits yet. Add your first Habits!</Text>
          </View>
        ) : (
            ...
            <Swipeable
              ...
              onSwipeableOpen={(direction) => {
                if(direction === "left"){
                  ...
                  handleCompletedHabits(habit.$id);
                }
